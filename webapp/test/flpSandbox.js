		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#vcpappvcpnpicharvalue-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vcpappvcpnpicharvalue-display": {
								"semanticObject": "vcpappvcpnpicharvalue",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vcpapp.vcpnpicharvalue",
									"url": sap.ui.require.toUrl("vcpapp/vcpnpicharvalue")
								}
							}
						}
					}
