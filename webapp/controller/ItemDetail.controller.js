sap.ui.define(
    ...
    function (
        ...
        return BaseController.extend("vcpapp.vcpnpicharvalue.controller.ItemDetail", {
            /**
            ...
            onInit: function () {
                ...
                this.bus.subscribe("data", "EmptyData", this.EmptyData, this);
            ...
            onAfterRendering: function () {
                ...
                that.oCharModel.setData({results1:that.totalUniqeData});
            ...
            EmptyData:function(){
                var data = [];
                that.oCharModel.setData({results1:data});
                that.byId("idMatvarItem").setModel(that.oCharModel);
